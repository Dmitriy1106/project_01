...
matrix.set_value(0, 0, 10) # Устанавливаем значение 1 в ячейку (0, 0)
matrix.set_value(0, 1, 20) # Устанавливаем значение 3 в ячейку (0, 1)
matrix.set_value(0, 2, 30)
matrix.set_value(0, 3, 40)
...
print(matrix.get_value(0, 0), matrix.get_value(0, 1), matrix.get_value(0, 2), matrix.get_value(0, 3))
print(matrix.get_value(1, 0), matrix.get_value(1, 1), matrix.get_value(1, 2), matrix.get_value(1, 3))
print(matrix.get_value(2, 0), matrix.get_value(2, 1), matrix.get_value(2, 2), matrix.get_value(2, 3))
print(matrix.get_value(3, 0), matrix.get_value(3, 1), matrix.get_value(3, 2), matrix.get_value(3, 3))
print(matrix.get_value(4, 0), matrix.get_value(4, 1), matrix.get_value(4, 2), matrix.get_value(4, 3))
